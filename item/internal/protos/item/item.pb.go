...
var file_item_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xf8, 0x01, 0x0a, 0x0b, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_item_proto_depIdxs = []int32{
	...
	5, // 6: ItemService.ItemCreate:output_type -> DeleteResponse
	1, // 7: ItemService.ItemGet:output_type -> GeneralItem
	4, // 8: ItemService.ItemsGet:output_type -> GetItemsResponse
	5, // 9: ItemService.ItemUpdate:output_type -> DeleteResponse
	5, // 10: ItemService.ItemDelete:output_type -> DeleteResponse
